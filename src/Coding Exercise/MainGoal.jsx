...
// DEFINE YOUR COMPONENT HERE // IMPORTANT: Add "export" in front of your component - otherwise the automated tests won't work // ... // DO NOT EDIT THE APP COMPONENT NAME OR CONTENT // Except for outputting your custom component
function MainGoal() {
...
function App() {
  return (
    <div id="app">
      ...
      {/* DON'T CHANGE THE TEXT / CONTENT ABOVE /} {/ OUTPUT YOUR COMPONENT HERE */}{" "}
      <MainGoal />{" "}
    </div>
  );
}
